...
It has been assumed that \(\beta\)-CaMKII get fast phosphorylated and facilitate the phosphorylation of \(\gamma\)-CaMKIIs. To model their interactions, following a similar scheme in Pepke et al. (2010), we assume the subsequent elementary steps occur between subunits of the two complexes. In particular, b is short for bound and p is short for phosphorylated.<br>
